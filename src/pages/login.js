    ...
    <>
      <div className="max-w-xs mx-auto mt-64 border border-solid border-black p-4 bg-gray-800 flex flex-center flex-col rounded-lg">
        ...
        <div className="rounded-lg bg-gray-200 w-48 mx-auto mb-6">
          <a href={`https://discordapp.com/api/oauth2/authorize?client_id=${process.env.CLIENT_ID}&redirect_uri=${redirect}&response_type=code&scope=identify`}>
          <svg className="fill-current text-indigo-700 h-16 pt-1 w-48" viewBox="0 0 800 272.1">
